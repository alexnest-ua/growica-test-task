...
> Обидва демо працюють на InstaWP як **постійні** sandbox-сайти, з увімкненим
> *Settings → Reading → Discourage search engines* на кожному (згідно з вимогою
> noindex — підтверджено мета-тегом `robots: noindex, nofollow` на кожній
> сторінці). InstaWP може показати коротку проміжну сторінку «Continue to site»
> при першому відвідуванні. Якщо демо колись стане недоступним, кожна тема
> встановлюється з цього репозиторію за лічені хвилини (див.
> [Встановлення](#встановлення-локально)).
